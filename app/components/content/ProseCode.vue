...
<template>
  <div class="relative borderline" :class="!!filename && ui.wrapper">
...
<style>
.borderlines {
  border: 6px solid red; /* Your desired border color */
}

pre {
  background-color: black; /* Fixed background color */
  color: #c02424; /* Fixed text color */
  padding: 1rem; /* Optional padding */
}

pre code {
  color: inherit; /* Ensure code inherits text color from pre */
}

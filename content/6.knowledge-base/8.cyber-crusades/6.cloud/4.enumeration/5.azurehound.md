...
You can also explore **pre-built queries** for Azure, which were sourced from a well-known Norwegian researcher, **Emulin**or use his [cheatsheet](https://hausec.com/2020/11/23/azurehound-cypher-cheatsheet/).

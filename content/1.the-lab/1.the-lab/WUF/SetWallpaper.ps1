...
4. Save File
5. Set Wallpaper and Screensaver
6. Log Success
#>
...
Write-Output "Configuring screensaver settings..."
Set-ItemProperty -Path 'HKCU:\Control Panel\Desktop' -Name 'SCRNSAVE.EXE' -Value 'C:\Windows\System32\PhotoScreensaver.scr'
Set-ItemProperty -Path 'HKCU:\Control Panel\Desktop' -Name 'ScreenSaveTimeOut' -Value 300  # Time in seconds (e.g., 5 minutes)
Set-ItemProperty -Path 'HKCU:\Control Panel\Desktop' -Name 'ScreenSaveActive' -Value 1

Write-Output "Screensaver configured successfully with Photo Screensaver."

...
<iframe src="/digital-fortress/blue-team/cyber-response-plan.pdf" width="100%" height="600px"></iframe>
...
icon: i-mdi:nuxt
target: _blank
to: https://docs.google.com/presentation/d/1ABC.../embed"
---
Template holder for slides
::

### Preview

<iframe src="https://docs.google.com/presentation/d/1ABC.../embed" width="600" height="400"></iframe>
...
```
<img src="images/sunset.jpg" alt="Beautiful Sunset" width="600" height="400" style="border: 1px solid #ccc;" loading="lazy" />
```
...
```markdown
<audio controls>
  <source src="/audio/Xeno - SSD (prod. MILØS & K Akira) (Directed by Ivar Atilgan).mp3" type="audio/mpeg">
...
<Matrix :headers="['Phase', 'Duration', 'Key Focus']" :rows="[
  ['Experimental', '1-2 months', 'Explore ideas, test core concepts'],
  ['MVP', '2-4 months', 'Build core features, internal feedback'],
  ['Alpha', '1-2 months', 'Feature complete, internal testing'],
  ['Beta', '2-3 months', 'External testing, bug fixes, polish'],

---
title:  Hacking Modus Operandi
description: In the shadowy underworld of the cyber grid, every hacker has their signature style—methods forged in the chaos of code, where digital phantoms strike from the darkness, exploiting vulnerabilities with surgical precision
---
...
1. **_Computer as a tool_**- Fraud, identity theft, phishing scams, spam, propagation of illegal material.
2. **_Computer as a target_** - Viruses, denial of service, malware.
3. **_Cyberterrorism_** - Government level attacks on foreign intelligence services and governments.
4. **_Cyberextortion_** - When a system is subjected to or threatened with repeated denial of service, ransomware or other attacks by malicious hackers.
5. **_Cyberwarfare_** - National-level attacks on other national-level agencies or infrastructure.
...
**_Cybercrime_** the term used to describe crimes directed at computers or other information communications technologies and crimes where computers or ICTs are an integral part of an offence.

**_Cyber security_** is the practice of defending computers, networks, servers, mobile devices, data from malicious attacks.

**_A Cyber-attack_** is an offensive manoeuvre to attempt to expose, alter, disable, destroy, steal or gain information through unauthorised access to or make unauthorised use of an asset.

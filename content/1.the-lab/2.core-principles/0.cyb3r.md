---
title:  Cyb3r
description:  Cybersecurity is the relentless guardian, a fusion of human instinct and machine precision, battling in the ever-evolving war to protect the sanctity of the virtual realm.
---

::card-group
  ::card
  ---
  title: You can not compete with one who never stops learning
  icon: teenyicons:doc-outline
  to: https://learn.microsoft.com/en-us/docs/
  target: _blank
  ---
  Students of the universe. Windows technical documentation here.
  ::
  ::card
  ---
  title: Microsoft Security Academy
  icon: grommet-icons:document-windows
  to: https://microsoft.github.io/PartnerResources/skilling/microsoft-security-academy/start
  target: _blank
  ---
  ...
  ::card
  ---
  title: Windows 11 Security Handbook
  icon: game-icons:doctor-face
  to: https://learn.microsoft.com/en-us/windows/security/book/
  target: _blank
  ---
  ...
  ::card
  ---
  title: Windows Cloud Security Benchmarks
  icon: material-symbols:cloud
  to: https://learn.microsoft.com/en-us/security/benchmark/azure/overview
  target: _blank
  ---
  The Microsoft cloud security benchmark (MCSB) provides prescriptive best practices and recommendations to help improve the security
  ::
::
...
target: _blank
to: https://learn.microsoft.com/en-us/training/modules/describe-basic-cybersecurity-threats-attacks-mitigations/2-describe-what-is-cybersecurity
---
...
![cia-triad](/content/1.the-lab/2.core-principles/0.cyb3r/cia-triad.png)

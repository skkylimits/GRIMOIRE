...
Use callout to emphasize important contextual information.
...
Github Highlights draw attention to notes, tips, warnings, or cautions, making key information stand out.
...
::code-preview
  :::div{.flex.flex-col.gap-4.w-full}
	...
	::::important{.w-full.my-0}
    This is a key detail that impacts how the feature works.
    ::::

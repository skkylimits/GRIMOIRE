...
- **6.1** Introduction to the Link Layer
  ...
  **Link layer: switches vs routers**
  ...
  - **6.1.2** Link Frames
    ...
    Link Frames
    #content
    ![Link Frames](./assets/link-frames.png)
    ::
  ...
  - **6.1.3** Where Is the Link Layer Implemented?
    ...
    ![Waar is de linklaag](./assets/waar-is-de-linklaag.png)
    ::
  ...
  - **6.1.3** How do adapters communicate?
    ...
    ![Hoe communiceren adapters](./assets/hoe-communiceren-adapters.png)
    ::
...
- **6.2** Error-Detection and -Correction Techniques
  ...
  - **D**: Data is beschermd tegen fouten, geldt soms ook voor headers.
    ...
    ![Error Detection](./assets/error-detection.png)
  ::
  ...
  - **6.2.1** Parity Checks
    ...
    ![Parity Checking](./assets/parity-checking.png)
    ::
  ...
  - **6.2.1.5** Two Dimensional Parity
    ...
    **Tweedimensionale Pariteitscontrole**
    ...
    ![Two Dimensional Parity Checking](./assets/two-dimensional-parity-checking.png)
    ::

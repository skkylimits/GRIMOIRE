...
target: _blank
to: https://gaia.cs.umass.edu/kurose_ross/lectures.php
---
[A top down approach](https://gaia.cs.umass.edu/kurose_ross/lectures.php)
::

<div style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%; overflow: hidden;">
  <iframe
	src="https://www.youtube.com/embed/p3vaaD9pn9I&t"
	frameborder="0"
...
::foldable
#title
De magische reis van Dorie

#content
Eens, in de uitgestrekte wereld van cyberspace, leefde een klein maar vastberaden pakketje genaamd **Dorie**. Dorie kwam van **Host A**, een bruisende hub van digitale activiteit, en had dromen om **Host B** te bereiken, een verre bestemming gehuld in mysterie.

Terwijl Dorie aan haar reis begon, ontmoette zij het **TCP/IP-model**, een imposante structuur die hem door de ingewikkelde paden van het internet leidde. Elke laag van het model omhulde Dorie als lagen van een harnas, hem beschermend tegen de gevaren van het digitale rijk.

**Encapsulation**, een magisch proces, omhulde Dorie binnen een beschermende schil, hem afschermend van de chaos van de buitenwereld. Met elke laag die zij doorliep, werd Dorie's doel duidelijker en groeide haar vastberadenheid.

Navigerend door het web, struikelde Dorie over **HTTP**, een vriendelijk protocol dat hem met open armen verwelkomde. Met de begeleiding van HTTP doorkruiste Dorie het uitgestrekte netwerk van onderling verbonden websites, elk een nieuw avontuur dat wachtte om ontdekt te worden.

Maar de reis van Dorie was verre van voorbij. Onderweg kwam zij **DNS** tegen, een wijze gids die geheimen fluisterde over domeinnamen en IP-adressen. Met de hulp van DNS vond Dorie zijn weg door het labyrint van servers en routers, steeds dichter bij zijn bestemming komend met elke stap.

**SMTP**, een ijverige boodschapper, hielp Dorie communiceren met andere pakketjes onderweg, ervoor zorgend dat zijn berichten zonder fouten hun beoogde ontvangers bereikten. Met SMTP aan zijn zijde voelde Dorie een gevoel van kameraadschap in de uitgestrektheid van de digitale wereld.

Terwijl Dorie dieper doordrong in de lagen van het internet, ontmoette zij **TCP** en **UDP**, twee formidabele strijders die verschillende paden naar zijn bestemming boden. TCP, een standvastige beschermer, zorgde voor betrouwbare gegevensoverdracht, terwijl UDP, een snelle boodschapper, snelheid boven alles prioriteerde.

In de **applicatielaag** leerde Dorie de kunst van efficiënte communicatie, de nuances van stroombeheer en schatting van de heen-en-terug-reistijd beheersen. Met deze vaardigheden kon zij zich aanpassen aan de altijd veranderende stromingen van de digitale oceaan, met gemak door turbulente wateren navigeren.

Maar de weg vooruit was bezaaid met gevaren. Terwijl Dorie de **netwerklaag** naderde, stond zij voor de ontmoedigende uitdagingen van routing en adressering. In het hart van een router aanschouwde Dorie de ingewikkelde dans van in-/uitvoerpoortverwerking en bestemmingsgerichte doorsturing, zich verwonderend over de complexiteit van de innerlijke werking van het netwerk.

**IPv4-adressering**, **NAT**, **DHCP** en **subnetting** onthulden zichzelf naarmate Dorie dieper doordrong in de netwerklaag, elk een vitaal onderdeel in het groots ontwerp van het internet. Met de **DORA**-dans van DHCP als gids verwierf Dorie de nodige middelen om zijn reis voort te zetten, zijn kracht aanvullend voor de weg die voor hem lag.

In de **controlelaag** van het netwerk stuitte Dorie op **routingsalgoritmen** zoals **LS** en **DV**, die elk een ander pad naar zijn bestemming boden. **Intra-AS** routeprotocollen zoals **OSPF** en **BGP** verlichtten de weg vooruit, Dorie door het ingewikkelde doolhof van netwerktopologie leidend.

Terwijl Dorie zijn bestemming naderde, verwonderde zij zich over de wonderen van **netwerkbeheer**, waar **SNMP** en **SDN** onvermoeibaar werkten om orde te handhaven in het digitale rijk. Met hun hulp kon Dorie elke hindernis overwinnen die zich op zijn weg bevond, voortgaand met onwrikbare vastberadenheid.

En zo ging de reis van Dorie verder, elke technologie als zijn gids, een testament van de veerkracht en vindingrijkheid van pakketjes overal. Hoewel de weg vooruit lang en onzeker was, drukte Dorie door, zijn geest ongebroken en zijn vastberadenheid onwankelbaar. Want in de uitgestrektheid van cyberspace was er altijd een nieuw avontuur dat wachtte om ontdekt te worden, en Dorie was klaar om het met beide handen aan te grijpen.

Daarnaast, terwijl Dorie zijn reis voortzette, ontdekte zij ook het **segmentatie**, **datagram** en **frame**, de bouwstenen van zijn digitale wereld. Elk speelde een cruciale rol in het veilig en efficiënt transporteren van zijn gegevens door het netwerk, waardoor Dorie met vertrouwen zijn weg kon vervolgen.

Aanvullend op zijn avontuur leerde Dorie over **cookies**, **webcaching**, **POP**, **IMAP**, **socket-programmering**, **UDP** en **TCP**, **pariteitscontroles**, **checksumming-methoden**, **CRC**, en **ARP**. Elke technologie verrijkte zijn kennis en stelde hem in staat om de complexe wereld van het internet met meer inzicht en vaardigheid te navigeren.
::
...
- **8.19** Downgrade Attack
  ...
  Antwoord
  #content
  ![downgrade-attackb](/content/7.knowledge-base/4.networking/0.index/downgrade-attackb.png)
  ::
...
<iframe
  src="/content/7.knowledge-base/4.networking/0.index/computer-networking-a-top-down-Approach-globaledition-8th-edition.pdf"
  width="100%"
  height="600px">
</iframe>

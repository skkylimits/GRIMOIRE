...
> Dit bespaart je zes maanden werk, waarin je grotendeels fulltime de DNS-rabbithole in zou duiken, RFC’s zou lezen, met experts zou praten en alles zou uitschrijven en opnemen.
...
Ik heb deze cursus opgezet in zes modules:

1. DNS vanuit de basisprincipes
2. Domeinnamen
3. Operationele DNS
4. Types DNS-records
5. E-mail en de DNS
6. Debuggen van DNS-problemen

::tip
Elke module eindigt met een quiz om je kennis te testen.
::

::important
Latere lessen bouwen voort op de kennis uit eerdere lessen, dus het is het beste om de cursus in de juiste volgorde te volgen.
::

## Zodra je klaar ben kan je:

- Een fundamenteel begrip hebben van DNS.
- DNS-records met vertrouwen kunnen configureren.
- DNS-problemen effectief kunnen debuggen.

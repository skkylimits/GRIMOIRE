...
- **3.3** Connectionless Transport: UDP
  ...
  **UDP's Simplicity**
  ...
  ![udp-segement](/content/7.knowledge-base/2.networking/0.index/udp-segement.png)
...
- **3.5** Connection-Oriented Transport: TCP
  ...
  **Gegevensoverdracht in een TCP-verbinding**
  ...
  - **3.5.2** TCP Segment Structure
    ...
    #content
    ![tcp-segment](/content/7.knowledge-base/2.networking/0.index/tcp-segment.png)
    ::
  ...
  - **3.5.6** TCP Connection Management
    ...
    **TCP-verbindingbeheer**
    ...
    ![tcp-3-way-handshake](/content/7.knowledge-base/2.networking/0.index/tcp-3-way-handshake.png)
    ::
...
- **3.10** TCP Retransmission
    ...
    **Timeout en Herverzending**
	...
	![tcp-retransmission-1](/content/7.knowledge-base/2.networking/0.index/tcp-retransmission-1.png)

	![tcp-retransmission-2](/content/7.knowledge-base/2.networking/0.index/tcp-retransmission-2.png)
    ::
...
- **4.1** Overview of Network Layer
  ...
  **Network layer**
  ...
  ![network-layer](/content/7.knowledge-base/2.networking/0.index/network-layer.png)
  ...
  **Data- en Controlevlak**
  ...
  - **4.1.1** Forwarding and Routing: The Data Control Planes
    ...
    **Analogy:**
    ...
    ![datagram-routing-en-forwarding](/content/7.knowledge-base/2.networking/0.index/datagram-routing-en-forwarding.png)
    ::
...
- **4.2** What’s Inside a Router?
  ...
  **Componenten van Een Router**
  ...
  ![componenten-van-een-router](/content/7.knowledge-base/2.networking/0.index/componenten-van-een-router.png)
  ...
  **Analogie van Routerfuncties**
  ...
  - **4.2.1** Input/Output Port Processing and Destination-Based Forwarding
    ...
    **Destination-Based Forwarding:** Dit is het proces waarbij een router een pakket naar de juiste uitvoerpoort stuurt op basis van de bestemmingsadressen in het pakket, zoals vastgelegd in de doorstuurtabel.
    ...
    ![input-port-functions](/content/7.knowledge-base/2.networking/0.index/input-port-functions.png)
    ::
  - **4.2.2** Switching
    ::foldable
    #title
    ...
    ![switching](/content/7.knowledge-base/2.networking/0.index/switching.png)
    ::
  ...
  - **4.2.3** Output Port Processing
    ...
    **Output Functions**
    ![output-port-functions](/content/7.knowledge-base/2.networking/0.index/output-port-functions.png)
    ::
...
- **4.3** The Internet Protocol (IP): IPv4, Addressing, IPv6, and More
  ...
  **IPv4 vs IPv6**
  ...
  ![ipv4-vs-ipv6](/content/7.knowledge-base/2.networking/0.index/ipv4-vs-ipv6.png)
  ::
  ...
  - **4.3.1** IPv4 Datagram Format
    ...
    Antwoord
    #content
    ![ipv4-datagram](/content/7.knowledge-base/2.networking/0.index/ipv4-datagram.png)
    ::
  ...
  - **4.3.4** IPv6
    ...
    **IPv6**
    ...
    ![ipv6-datagram](/content/7.knowledge-base/2.networking/0.index/ipv6-datagram.png)
    ::
...
- **4.4** Generalized Forwarding and SDN
  ...
  **Software-defined Networking (SDN):**
  ...
  ![sdn](/content/7.knowledge-base/2.networking/0.index/sdn.png)
  ::
  ...
  - **4.4.1** Match
	...
	![match](/content/7.knowledge-base/2.networking/0.index/match.png)
	::
  ...
  **DHCP: Dynamic Host Configuration Protocol**
  ...
  - **4.6.1** DHCP DORA
	...
	**DHCP - DORA**
	...
	![dhcp-dora](/content/7.knowledge-base/2.networking/0.index/dhcp-dora.png)
	::
  ...
  - **4.6.2** DHCP client-server scenario
	...
	**DHCP Client-Server Scenario**
	...
	![dhcp-client-server](/content/7.knowledge-base/2.networking/0.index/dhcp-client-server.png)
	::
  ...
  **Decentralized:**
  ...
  - **5.2.1** The Link-State (LS) Routing Algorithm
    ...
    **A Link-State Routing Algorithm: Dijkstra's Algorithm**
    ...
    ![dijkstra-algoritme](/content/7.knowledge-base/2.networking/0.index/dijkstra-algoritme.png)
    ::
...
- **6.1** Introduction to the Link Layer
  ...
  **Link layer: switches vs routers**
  ...
  - **6.1.1** The Services Provided by the Link Layer
    ...
    ![mac-address](/content/7.knowledge-base/2.networking/0.index/mac-address.png)
    ::
  ...
  - **6.1.2** Link Frames
    ...
    Link Frames
    #content
    ![link-frames](/content/7.knowledge-base/2.networking/0.index/link-frames.png)
    ::
  ...
  - **6.1.3** Where Is the Link Layer Implemented?
    ...
    ![waar-is-de-linklaag](/content/7.knowledge-base/2.networking/0.index/waar-is-de-linklaag.png)
    ::
  ...
  - **6.1.3** How do adapters communicate?
    ...
    ![hoe-communiceren-adapters](/content/7.knowledge-base/2.networking/0.index/hoe-communiceren-adapters.png)
    ::
...
- **6.2** Error-Detection and -Correction Techniques
  ...
  - **D**: Data is beschermd tegen fouten, geldt soms ook voor headers.
    ...
    ![error-detection](/content/7.knowledge-base/2.networking/0.index/error-detection.png)
  ::
  ...
  - **6.2.1** Parity Checks
    ...
    ![parity-checking](/content/7.knowledge-base/2.networking/0.index/parity-checking.1e8526c0.png)
    ::
  ...
  - **6.2.1.5** Two Dimensional Parity
    ...
    **Tweedimensionale Pariteitscontrole**
    ...
    ![two-dimensional-parity-checking](/content/7.knowledge-base/2.networking/0.index/two-dimensional-parity-checking.png)
    ::
...
- **8.8** Symmetric key cryptography
  ...
  **Cryptografie**
  ...
  ![symmetric-crytpography](/content/7.knowledge-base/2.networking/0.index/symmetric-crytpography.png)
  ::
...
- **8.9** Asymmetrische key cryptografie
  ...
  ![simple-encryption-scheme](/content/7.knowledge-base/2.networking/0.index/simple-encryption-scheme.png)

  ![public-key-crypto](/content/7.knowledge-base/2.networking/0.index/public-key-crypto.png)

  ![public-key-cryptography](/content/7.knowledge-base/2.networking/0.index/public-key-cryptography.png)
  ::
...
- **8.10** Certificate Authority
  ...
  Antwoord
  #content
  ![certificate-authorities](/content/7.knowledge-base/2.networking/0.index/certificate-authorities.png)
  ::
...
- **8.11** Digital Signatures
  ...
  Antwoord
  #content
  ![digital-signatures](/content/7.knowledge-base/2.networking/0.index/digital-signatures.png)
  ::
...
- **8.12** Message digests
  ...
  Antwoord
  #content
  ![message-digest](/content/7.knowledge-base/2.networking/0.index/message-digest.png)
  ::
...
- **8.13** SSL TCP/IP
  ...
  Antwoord
  #content
  ![ssl-tcip](/content/7.knowledge-base/2.networking/0.index/ssl-tcip.png)
  ::
...
- **8.14** Firewall
  ...
  Antwoord
  #content
  ![firewall](/content/7.knowledge-base/2.networking/0.index/firewall.png)
  ::
...
- **8.15** Packet Filtering
  ...
  Antwoord
  #content
  ![packet-filtering](/content/7.knowledge-base/2.networking/0.index/packet-filtering.png)
  ::
...
- **8.16** IDS
  ...
  Antwoord
  #content
  ![ids](/content/7.knowledge-base/2.networking/0.index/ids.png)

  ![ids-sensors](/content/7.knowledge-base/2.networking/0.index/ids-sensors.png)
  ::
...
- **8.17** Demilitarized Zone (DMZ)
  ...
  Antwoord
  #content
  ![dimilitarized-zone](/content/7.knowledge-base/2.networking/0.index/dimilitarized-zone.png)
  ::
...
- **8.18** VPN
  ...
  Antwoord
  #content
  ![vpn](/content/7.knowledge-base/2.networking/0.index/vpn.png)
  ::
...
- **8.19** Downgrade Attack
  ...
  Antwoord
  #content
  ![downgrade-attackb](/content/7.knowledge-base/2.networking/0.index/downgrade-attackb.png)
  ::
...
<iframe
  src="/content/7.knowledge-base/2.networking/0.index/computer-networking-a-top-down-Approach-globaledition-8th-edition.pdf"
  width="100%"
  height="600px">
</iframe>

...
::field{name="Exercise 2"}
  ::collapsible{name=""}
  :field{name="Question 2"}
    1. Functionality Identification: Provide students with a complex web page that includes

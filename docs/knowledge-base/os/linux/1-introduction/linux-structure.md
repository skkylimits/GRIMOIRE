...
| `Daemons`         | Background services are called "daemons" in Linux. Their purpose is to ensure that key functions such as scheduling, printing, and multimedia are working correctly. These small programs load after the system has booted or logged into the computer. |
...
<img src="../assets/NEW_filesystem.png" />

...
to: https://symbl.cc/en/tools/morse/
target: _blank
---
...
![morse-device](/content/2.syntax/0.morse/0.index/morse-device.png)
...
![morse-speed](/content/2.syntax/0.morse/0.index/morse-speed.png)

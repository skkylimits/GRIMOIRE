...
import { normalizeImagePathInMarkdown } from '../../../scripts/markdown/NormalizeImagePath'

// Test cases for normalizeImagePathInMarkdown
describe('normalizeImagePathInMarkdown', () => {
	// Basic cases
	it('case 1: handles root level paths with public/', () => {
		...
		expect(normalizeImagePathInMarkdown(input)).toBe(output)
	})
